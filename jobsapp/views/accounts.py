...
class RegisterEmployeeView(CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            user.save()
            messages.success(request, 'You have registered as JobSeeker /Employee !')
...
class RegisterEmployerView(CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            user.set_password(password)
            user.save()
            messages.success(request, 'You have registered  as Employer!')
            return redirect('jobs:login')
        else:
...
class LoginView(FormView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, 'Welcome to our WebPage.Finally you are logged in! ')
        return HttpResponseRedirect(self.get_success_url())
